...
This Python version works properly as of this version, however it is to be noted that the plugboard is hardcoded, will resolve soon.

This code will probably be moved to dart and into a flutter application before the Arduino port.
